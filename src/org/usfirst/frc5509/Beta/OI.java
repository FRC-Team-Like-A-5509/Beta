...
public class OI {
    ...
    public OI() {
        ...
        outTake = new JoystickButton(copilotJoystick, 6);
        outTake.whileHeld(new Outtake());
        inTake = new JoystickButton(copilotJoystick, 5);
        inTake.whileHeld(new Intake());
        shoot = new JoystickButton(copilotJoystick, 1);
        ...
        SmartDashboard.putData("Wench", new Wench());
